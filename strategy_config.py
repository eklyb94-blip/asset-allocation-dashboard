...
▶ 포트폴리오 구성 (전략8)
    ...
    - 금 (고정):   20%
    - 한국채10년 (고정): 10%  → KODEX 국채선물10년 (148070)
    - 미국채10년 (고정): 10%  → KODEX 미국10년국채선물 (304660)
    - 현금대체 (잔여): 나머지 → KODEX 국고채3년 (114820)
...
ETF_TICKERS = {
    ...
    "csi300": "168580",   # KODEX 차이나CSI300
    "gold":   "411060",   # ACE KRX금현물
    "krbond": "114820",   # KODEX 국고채3년 (현금대체)
    "kr10y":  "148070",   # KODEX 국채선물10년 (한국, 고정 10%)
    "us10y":  "304660",   # KODEX 미국10년국채선물 (고정 10%)
}
